    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-2 px-3" id="nav-items">
                <li class="nav-item">
                    <a href="{{ route('user.profile.index') }}" class="flex items-center p-3 text-gray-300 rounded-lg hover:bg-[#ff4d4d]/10 
                ...
                <li class="nav-item">
                    <a href="{{ route('user.events') }}" class="flex items-center p-3 text-gray-300 rounded-lg hover:bg-[#ff4d4d]/10 
                        hover:text-[#ff4d4d] transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 transition-transform duration-300 group-hover:rotate-6" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li class="nav-item">
                    <a href="{{ route('user.categories.index') }}" class="flex items-center p-3 text-gray-300 rounded-lg hover:bg-[#ff4d4d]/10 
                        hover:text-[#ff4d4d] transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 transition-transform duration-300 group-hover:rotate-6" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
