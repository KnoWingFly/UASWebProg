...
<div class="min-h-screen bg-gray-900 text-white p-8">
    <div class="max-w-7xl mx-auto">
        ...
        @if(session('success'))
            <div class="p-4 mb-4 text-sm text-green-400 rounded-lg bg-gray-800" role="alert">
                {{ session('success') }}
            </div>
        @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="bg-gray-800 p-6 rounded-lg text-center">
                ...
                <a href="{{ route('admin.categories.index') }}"
                    class="w-full flex items-center justify-center px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @if($recentMaterials->isNotEmpty())
                    @foreach($recentMaterials as $material)
                        <div class="flex items-center justify-between p-4 hover:bg-gray-700 rounded-lg transition-colors"
                            ...
                            <!-- Ensure category is passed here -->
            ...
            <div class="relative bg-gray-800 rounded-lg shadow">
                ...
                <form class="p-4 md:p-5" action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-white">Category
                                Name</label>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-gray-800 rounded-lg shadow">
                ...
                <form class="p-4 md:p-5" action="{{ route('admin.materials.store') }}" method="POST">
                    ...
                    <button type="submit"
                        class="text-white inline-flex items-center bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z"
                                clip-rule="evenodd"></path>
